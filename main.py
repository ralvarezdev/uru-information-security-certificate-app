...
from ralvarezdev import certificate_pb2, certificate_pb2_grpc

# Set the grpc microservice address
stub = create_grpc_client(CERTIFICATE_GRPC_HOST, CERTIFICATE_GRPC_PORT)
